...
class TextH1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) => new Padding(
      ...
      child: new Text(
        text,
        style: TextStyle(fontFamily: "SFProDisplay", fontSize: 30, color: primaryTextColor, fontWeight: weight),
      ));
}
...
class TextH2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) => new Padding(
      ...
      child: new Text(
        text,
        style: TextStyle(fontFamily: "SFProDisplay", fontSize: 25, color: primaryTextColor, fontWeight: weight),
      ));
}
...
class TextH3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) => new Padding(
      ...
      child: new Text(
        text,
        style: TextStyle(fontFamily: "SFProDisplay", fontSize: 20, color: primaryTextColor, fontWeight: weight),
      ));
}
...
class TextH4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) => new Padding(
      ...
      child: new Text(
        text,
        style: TextStyle(fontFamily: "SFProDisplay", fontSize: 15, color: color != null ? color : primaryTextColor, fontWeight: weight),
      ));
}
...
class TextH5 extends StatelessWidget {
  ...
  Widget build(BuildContext context) => new Padding(
      ...
      child: new  Text(
        text,
        style: TextStyle(fontFamily: "SFProDisplay", fontSize: 12, color: primaryTextColor, fontWeight: weight),
      ));
}
...
class TextH6 extends StatelessWidget {
  ...
  Widget build(BuildContext context) => new Padding(
      ...
      child: new Text(
        text,
        style: TextStyle(fontFamily: "SFProDisplay", fontSize: 8, color: primaryTextColor, fontWeight: weight),
      ));
}
