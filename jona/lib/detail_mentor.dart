...
class DetailMentor extends StatelessWidget {
  ...
  DetailMentor({Key key, this.studyInfo, this.index, this.course})
      : super(key: key);
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder:
                                      (BuildContext ctxt, int indexExp) {
                                    return new Column(
                                        crossAxisAlignment:
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, indexPaket) {
                                return cardPaket(
                                    ...
                                    listPaket[indexPaket]["pertemuan"]
                                        .toString(),
  ...
  Widget cardPaket(String bulan, String pertemuan, String harga, String nama,
      String whatsapp, String course) {
    return Container(
      width: 280,
      child: InkWell(
          onTap: () async {
            ...
            //     "https://api.whatsapp.com/send/?phone=$whatsapp&text=Halo kak $nama saya telah melakukan pemesanan paket belajar pada Aplikasi Jona dengan paket $bulan bulan $pertemuan kali pertemuan dengan harga Rp. $harga. mohon di proses ya. "));
            var firebaseUser = FirebaseAuth.instance.currentUser;
            firestoreInstance.collection("log_pemesanan_course").add({
              "course": "$course",
              "id_pemesanan": firebaseUser.uid,
              "nama_mentor": "$nama",
              "paket": {
                "bulan": "$bulan",
                "pertemuan": "$pertemuan",
